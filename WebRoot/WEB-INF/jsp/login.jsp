		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<div>${session.loginerror }${requestScope.loginerror }</div>
					<form id="loginForm" action="${ pageContext.request.contextPath }/login.action"  method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
										用户名:
							...
							<tr>
							<tr><th></th>
							<td>${requestScope.checkImgError }${loginPlease }</td>
							</tr>
								<th>&nbsp;
