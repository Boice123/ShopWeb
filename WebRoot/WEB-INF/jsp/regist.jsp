...
<script>
	...
	function checkPassword(){
		...
		if(password == null || password == ''){
			...
			document.getElementById("span2").innerHTML = "密码长度需在3-13之间";
			document.getElementById("span2").style.color = "red";
		}else{
			document.getElementById("span2").innerHTML = "密码可以使用";
	...
	function checkRePassword(){
		...
		if(repassword == null || repassword == ''){
			document.getElementById("span3").innerHTML = "请填写确认密码";
	...
	function checkEmail(){
		...
		var myreg = /^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}$/;
		if(email == null || email == ''){
			document.getElementById("span4").innerHTML = "请填写邮箱地址";
			document.getElementById("span4").style.color = "red";
		}else if(!myreg.test(email)){
			document.getElementById("span4").innerHTML = "邮箱地址有误";
			document.getElementById("span4").style.color = "red";
		}else{
			document.getElementById("span4").innerHTML = "邮箱地址正确";
	...
	function checkUsername(){
		...
		// 3.打开连接
		xhr.open("GET","${pageContext.request.contextPath}/findUserByUserName.action?time="+new Date().getTime()+"&username="+username,true);
		// 4.发送
		xhr.send(null);
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/regist.action"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
