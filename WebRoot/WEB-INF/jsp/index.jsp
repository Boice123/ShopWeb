...
<div class="container index">
		...
		<div class="span24">
			<div id="hotProduct" class="hotProduct clearfix">
					...
					<ul class="tab">
							<li class="current">
								<a href="./商品分类.htm?tagIds=1" target="_blank"></a>
							</li>
							<li>
								<a  target="_blank"></a>
							</li>
...
<!-- 					<div class="hotProductAd">
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<c:forEach items="${requestScope.hotlist }" var="h">
									<li>
										<a href="${pageContext.request.contextPath }/product/findByPid.action?pid=${h.pid}"target="_blank"><img src="${pageContext.request.contextPath}/${h.image}" style="display:block;"/></a>
									</li>
						</c:forEach>
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
					...
					<ul class="tab">
							<li class="current">
								<a href="./商品分类.htm?tagIds=2" target="_blank"></a>
							</li>
							<li>
								<a  target="_blank"></a>
							</li>
...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;">
							 <c:forEach items="${requestScope.newlist }" var="n">
									<li>
										<a href="${pageContext.request.contextPath }/product/findByPid.action?pid=${n.pid}" target="_blank"><img src="${pageContext.request.contextPath}/${n.image}" style="display:block"/></a>
									</li>
						 	</c:forEach>
						</ul>
						<ul class="tabContent" style="display: none;">
