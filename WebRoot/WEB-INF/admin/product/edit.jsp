...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/admin/adminProduct/update.action" method="post" enctype="multipart/form-data">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="categorySecond.csid">
							<c:forEach  var="cs" items="${ csList}">
								<option value="${cs.csid }" <c:if test="${ cs.csid== product.categorySecond.csid}">selected</c:if>>${cs.csname }</option>
							</c:forEach>
						</select>
					</td>
				</tr>
